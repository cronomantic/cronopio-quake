...
i32 ramp1[8] = {0x6f, 0x6d, 0x6b, 0x69, 0x67, 0x65, 0x63, 0x61};
i32 ramp2[8] = {0x6f, 0x6e, 0x6d, 0x6c, 0x6b, 0x6a, 0x68, 0x66};
i32 ramp3[8] = {0x6d, 0x6b, 6, 5, 4, 3};
...
/* [cronopio] R_UpdateParticles was declared in r_local.h on the fork branch;
 * this compat override keeps the upstream headers pure, so forward-declare it
 * here (R_DrawParticles below calls it before its definition). */
